...
<body style="background-color: #f4f5f7;">
  ...
  <div class="table-container">
    ...
    <div class="d-flex  mb-4">
      <a href="/result" class="btn" style="background-color:#00ab41;border:none;color:white;padding:7px 40px;border-radius:2px">View Results</a>
    </div>
    <table class="table table-bordered" style="color: #212122;">
      ...
      <tbody>
        <tr>
          ...
          <td>
            <a href="/detail" style="text-decoration: none;color:#00ab41">More Details</a>
          </td>
        </tr>
