        ...
        <table class="table table-bordered" style="color: #212122;">
            <thead>
                <tr class="text-center">
                    ...
                    <th scope="col">Number shortlisted</th>
                    <th> </th>
                </tr>
            </thead>
            <tbody>
                <tr class="text-center">
                    ...
                    <td>
                        <a href="/shortlisted" class="btn" style="background-color:#00ab41;border:none;color:white;padding:5px 30px;border-radius:2px">View Result</a>
                    </td>
                </tr>
